        ...
        <div className="relative rounded-2xl border border-white/10 bg-[#12171E]/80 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.45)] sm:p-6 md:p-7">
          ...
          <div className="mt-6 flex flex-col items-center">
            ...
            <p className="mt-3 max-w-prose text-center text-sm text-white/70 italic">
              Milan (16 godina): Nakon 2 meseca zarađujem više od džeparca i mogu sebi da kupim šta god hoću.
            </p>
          </div>
          ...
          <button
            ...
            className="mt-4 w-full rounded-xl bg-gradient-to-b from-amber-400 to-amber-600 px-5 py-4 text-center text-lg font-semibold text-black shadow-[0_14px_40px_rgba(212,160,32,0.45)] transition hover:brightness-110 disabled:opacity-60"
          >
          ...
          {saved && (
            <p className="mt-3 inline-flex items-center gap-2 text-sm font-medium text-emerald-400">
              <CheckCircle2 className="h-4 w-4" /> Sačuvano! (slanje mejlom/bazu stiže uskoro)
            </p>
          )}
