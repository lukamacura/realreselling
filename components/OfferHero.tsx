...
// ---- Component ----
export default function OfferHeroOneScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-[1180px] px-4">
        <div className="grid content-center gap-6 py-6 md:grid-cols-2 md:items-center md:gap-10 md:py-10">
          {/* LEFT */}
          <div className="flex flex-col gap-2 md:gap-6">
            ...
            <h1
              id="offer-title"
              className="font-black leading-tight tracking-tight text-balance text-[clamp(22px,4.2vw,40px)]"
            >
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
              <div className="flex flex-wrap items-baseline gap-x-4 gap-y-2">
                ...
                <p className="text-xl sm:text-2xl font-black tracking-tight text-white">
                  Specijalna cena: <span className="text-amber-300">50€</span>
                </p>
              </div>
            ...
            <div className="space-y-1">
              <p className="text-center text-xs text-zinc-300">👇 Klikni na dugme kako bi pristupio programu 👇</p>
              <Link
                href="/discount"
              ...
              >
                <Sparkles className="h-6 w-6" /> Želim pristup programu
              </Link>
              <p className="text-center text-xs text-zinc-300">
                sigurno plaćanje uz stripe • može i bez kartice • odmah dobijaš pristup
              </p>
            </div>
            ...
            <ul className="grid grid-cols-1 gap-1 text-sm sm:text-[15px]">
              ...
              <li className="pt-1 text-right text-sm text-zinc-300">
                Specijalna ponuda: <span className="font-semibold text-amber-300">50€</span>
              </li>
            </ul>
          </div>
